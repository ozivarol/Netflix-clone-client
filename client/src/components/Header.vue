<template>
  <header :class="[{ scroll: isScroll }, 'header']">
    <nav class="header__nav">
      <router-link :to="{ name: 'HomePage' }" @click="scrollTop" class="header__link header__link--logo" to="/"><svg
      ...
      <div class="header__navbar">
        ...
        <div ref="navRef" class="header__links">
          <router-link @click="scrollTop" class="header__link" to="/home">Home</router-link>
      ...
      <div @click="getFocus" class="header__search">
        <form @submit.prevent>
          <input v-model="search" ref="searchRef" id="textField" name="search" autocomplete="off"
            placeholder="Titles, people, genres" class="header__input" type="text" @keydown.enter="goToSearch" />
        </form>
...
const scroll = () => {
  window.pageYOffset > 30 ? (isScroll.value = true) : (isScroll.value = false)
}
