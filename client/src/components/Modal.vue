  ...
  <div class="modal">
    <div class="modal__content">
      <div class="modal__video">
        ...
        <iframe class="modal__video-frame"
          :src="`https://www.youtube.com/embed/${cardInfo.videos.results[0].key}?autoplay=1`" frameborder="0"
        ...
        <div class="modal__overlay">
          ...
          <div class="modal__btns">
            <button @click="watchMovie" class="modal__btn modal__btn--play">
              <i class="fas fa-play modal__icon modal__icon--play"></i>
            </button>
            ...
            <button @click="$emit('likeMovie')" :class="[{ act: cardInfo.isLiked }, 'modal__btn']">
              <i class="far fa-thumbs-up modal__icon"></i>
            </button>
            <button @click="$emit('dislikeMovie')" :class="[{ act: cardInfo.isLiked === false }, 'modal__btn']">
        ...
        <div class="modal__cards">
          <div :key="index" v-for="(item, index) in related" class="modal__card">
            <div class="modal__card-main">
              ...
              <img class="modal__card-img" :src="`https://image.tmdb.org/t/p/w300${item.backdrop_path}`" alt="" />
            </div>
